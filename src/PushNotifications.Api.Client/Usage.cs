...
namespace PushNotifications.Api.Client
{
    static class Usage
    {
        static void Main()
        {
            ...
            var pruvitSubscribe = pnClient.UnSubscribeForFireBase(new SubscriptionForFireBase(pruvitUrn, "eh31SYk_ELA:APA91bHwJN5-hBY6KBmN01kFnSSPBFeJeTixnYQBvny77KsFTDgIY0Gb0JnTUd6q7AEfedg_qWMvJQ-IpyzjUpa4EA1VDupMkwNCz179YDCkRueTRxDCE_SkdpfLYkO96M09JZowK5K5"));
            ...
            var x = pnClient.SendPushNotification(new Models.SendPushNotificationModel(pruvitUrn, $"hiiiiiiiiiiiiii from KV", "this is body", "default", string.Empty, 0, t, true));
