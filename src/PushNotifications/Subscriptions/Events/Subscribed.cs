...
public sealed class Subscribed : IEvent
{
    Subscribed() { }

    public Subscribed(DeviceSubscriptionId id, DeviceSubscriberId subscriberId, SubscriptionToken subscriptionToken, DateTimeOffset timestamp)
    {
