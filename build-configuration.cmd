...
%FAKE% %NYX% appName=PushNotifications.WS           appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetkey=%RELEASE_NUGETKEY% target=Build appReleaseNotes=src/PushNotifications.WS.MSI/PushNotifications.WS.MSI.rn.md
