...
%FAKE% %NYX% appName=PushNotifications.WS.MSI       appSummary=%SUMMARY% appDescription=%DESCRIPTION% nugetserver=%NUGET_SOURCE_DEV_PUSH% nugetkey=%RELEASE_NUGETKEY% appType=msi
