...
%FAKE% %NYX% "target=Build"    appName=PushNotifications.WS appSummary=%SUMMARY% appDescription=%DESCRIPTION%
%FAKE% %NYX% "target=%TARGET%" appName=PushNotifications.WS.MSI appType=msi appSummary=%SUMMARY% appDescription=%DESCRIPTION%
%FAKE% %NYX% "target=%TARGET%" appName=PushNotifications.Api appSummary=%SUMMARY% appDescription=%DESCRIPTION%
